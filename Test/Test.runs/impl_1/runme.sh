...
HD_PWD='C:/Users/idowe/myProjects/FPGA-Course-Logtel/Test/Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Synchronizer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Synchronizer.tcl -notrace
