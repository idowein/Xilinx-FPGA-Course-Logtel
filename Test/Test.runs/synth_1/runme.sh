...
HD_PWD='C:/Users/idowe/myProjects/FPGA-Course-Logtel/Test/Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Synchronizer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Synchronizer.tcl
