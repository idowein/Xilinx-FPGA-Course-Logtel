...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/xilinx_book_labs/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reset_bridge.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reset_bridge.tcl -notrace
