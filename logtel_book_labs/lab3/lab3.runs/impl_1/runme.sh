...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NUCLEAR_ALARM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NUCLEAR_ALARM.tcl -notrace
