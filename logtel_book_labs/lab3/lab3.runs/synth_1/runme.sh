...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NUCLEAR_ALARM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NUCLEAR_ALARM.tcl
