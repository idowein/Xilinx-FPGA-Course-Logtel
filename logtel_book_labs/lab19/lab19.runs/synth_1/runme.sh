...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab19/lab19.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BH_DEMO_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BH_DEMO_wrapper.tcl
