...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab19/lab19.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BH_DEMO_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BH_DEMO_wrapper.tcl -notrace
