...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab7/lab7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log histogram_median_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source histogram_median_unit.tcl
