...
synth_design -top histogram_median_unit -part xc7z020clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef histogram_median_unit.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file histogram_median_unit_utilization_synth.rpt -pb histogram_median_unit_utilization_synth.pb"
