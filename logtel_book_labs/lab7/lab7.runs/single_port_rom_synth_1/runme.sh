...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab7/lab7.runs/single_port_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_port_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_port_rom.tcl
