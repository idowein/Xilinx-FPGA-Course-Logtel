...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab7/lab7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log histogram_median_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source histogram_median_unit.tcl -notrace
