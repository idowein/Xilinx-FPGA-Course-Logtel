...
void relocate(char *dp)
{
	...
	iki_vhdl_file_variable_register(dp + 147200);
	iki_vhdl_file_variable_register(dp + 147256);
...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 152680, dp + 155624, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 153776, dp + 155680, 0, 9, 0, 9, 10, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 152680, dp + 221376, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 154016, dp + 221432, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 153856, dp + 221488, 0, 7, 0, 7, 8, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 153896, dp + 221544, 0, 9, 0, 9, 10, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 152680, dp + 221600, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 153936, dp + 221656, 0, 7, 0, 7, 8, 1);
