...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab16/lab16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LOGIC_BREAKING_UNIT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LOGIC_BREAKING_UNIT.tcl -notrace
