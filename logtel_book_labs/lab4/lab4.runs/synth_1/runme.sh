...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parking.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parking.tcl
