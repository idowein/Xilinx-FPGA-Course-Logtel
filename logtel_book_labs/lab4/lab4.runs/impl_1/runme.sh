...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab4/lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parking.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parking.tcl -notrace
