...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_COUNTER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DEMO_COUNTER.tcl -notrace
