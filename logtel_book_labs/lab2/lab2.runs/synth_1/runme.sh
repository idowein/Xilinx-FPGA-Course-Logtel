...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_COUNTER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMO_COUNTER.tcl
