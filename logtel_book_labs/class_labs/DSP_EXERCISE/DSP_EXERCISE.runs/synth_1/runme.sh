...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/class_labs/DSP_EXERCISE/DSP_EXERCISE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MULTIPLIER_UNIT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MULTIPLIER_UNIT.tcl
