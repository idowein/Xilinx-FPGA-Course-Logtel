...
#set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { QSPI_CSN }]; #IO_L6P_T0_FCS_B_14 Sch=qspi_csn THIS IS MY XDC. WRITE A DESIGN FOR vga CONYTOLLER THAT FOR THE 0-3 BUTTONS TRANMIT ONLY RED, FOR 4-7 ONLY GREEN AND 7-10 ONLY BLUE