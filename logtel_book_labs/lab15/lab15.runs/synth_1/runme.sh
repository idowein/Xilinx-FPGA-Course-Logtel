...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab15/lab15.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CALCULATOR_UNIT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CALCULATOR_UNIT.tcl
