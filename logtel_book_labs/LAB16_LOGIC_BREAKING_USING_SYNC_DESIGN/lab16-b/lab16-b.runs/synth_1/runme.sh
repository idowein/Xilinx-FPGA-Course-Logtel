...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab16-b/lab16-b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_pipeline.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comparator_pipeline.tcl
