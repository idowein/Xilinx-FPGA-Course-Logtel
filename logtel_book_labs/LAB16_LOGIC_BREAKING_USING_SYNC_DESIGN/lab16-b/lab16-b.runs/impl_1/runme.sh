...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab16-b/lab16-b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_pipeline.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comparator_pipeline.tcl -notrace
