...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab16/lab16.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log LOGIC_BREAKING_UNIT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LOGIC_BREAKING_UNIT.tcl
