...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab15/lab15.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CALCULATOR_UNIT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CALCULATOR_UNIT.tcl -notrace
