...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab12/lab12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MMCM_4_CHANNELS_UNIT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MMCM_4_CHANNELS_UNIT.tcl -notrace
