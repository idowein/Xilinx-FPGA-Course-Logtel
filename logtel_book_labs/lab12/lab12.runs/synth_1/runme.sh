...
HD_PWD='C:/Users/idowe/FPGA Projects/FPGA-Course-Logtel/logtel_book_labs/lab12/lab12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MMCM_4_CHANNELS_UNIT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MMCM_4_CHANNELS_UNIT.tcl
