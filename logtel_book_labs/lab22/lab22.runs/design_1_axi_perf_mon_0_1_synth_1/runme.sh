...
HD_PWD='C:/Users/idowe/lab22/lab22.runs/design_1_axi_perf_mon_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_perf_mon_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_perf_mon_0_1.tcl
